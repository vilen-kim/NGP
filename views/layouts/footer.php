...
<footer class="container row center-block">
    ...
    <div class="col-sm-2">
        ...
        <div><?= Html::a('Сведения о реализуемых требованиях к защите ПД', ['site/show', 'id' => 865]) ?></div>
      <div><?= Html::a('Политика оператора в отношении обработки ПД', ['site/show', 'id' => 12]) ?></div>
    </div>
