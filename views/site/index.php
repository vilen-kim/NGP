    ...
    <?php if (!Yii::$app->mobileDetect->isMobile()){ ?>
        <div class="callDoctor">
            <div class="col-sm-12 text-justify" style="margin-bottom: 20px;">
                Вызов на дом врача-терапевта участкового (фельдшера) должен быть <b><?= Html::a('обоснован', '#', ['id' => 'showDoctor']) ?></b>.<br>Вызов врача-терапевта участкового (фельдшера) осуществляется в будни с 8:00 до 12:00.<br>Вызов бригады неотложной помощи: в будние дни - с 8:00 до 16:00, в субботу - с 8:00 до 14:00.
            </div>
