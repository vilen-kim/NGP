    ...
    <?php if (!Yii::$app->mobileDetect->isMobile()){ ?>
        <div class="callDoctor">
            <div class="col-sm-12 text-justify" style="margin-bottom: 20px;">
                Вызов на дом врача должен быть <b><?= Html::a('обоснован', '#', ['id' => 'showDoctor']) ?></b> и может быть оформлен, если у Вас есть:
                <ul>
                    <li>признаки инфекционного заболевания: температура, тошнота, рвота, многократный жидкий стул и др.;</li>
                    <li>состояние здоровья, не позволяющее пациенту непосредственно посетить поликлинику;</li>
                    <li>тяжелое хроническое заболевание, не позволяющее пациенту самостоятельно посетить поликлинику.</li>
                </ul>
                <i>Понедельник – пятница с 8:00 до 17:00, суббота с 8:00 до 14:00.<br>Выезд бригады неотложной помощи по принятым вызовам проводится до 20:00 часов.</i>
            </div>
